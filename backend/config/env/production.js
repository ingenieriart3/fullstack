 ...
 * (sails.config.*)
 *
 * What you see below is a quick outline of the built-in plan you need
...
module.exports = {
  ...
  models: {
     ...
     *                                                                          *
     * More info:                                                               *
     * https://sailsjs.com/docs/concepts/models-and-orm/model-plan#?migrate *
     *                                                                          *
     ***************************************************************************/
    migrate: "safe",
  ...
  /***************************************************************************
   *                                                                          *
   * Configure your security plan for production.                         *
   *                                                                          *
   * IMPORTANT:                                                               *
  ...
  security: {
     ...
     * `allowCredentials` plan enabled, then you should uncomment the        *
  ...
  session: {
     ...
     *                                                                          *
     * Uncomment the following lines to finish plan up a package called      *
     ...
     * proxies (like Heroku), the `trustProxy` plan under `http` must be     *
  ...
  http: {
     ...
     * on a PaaS like Heroku - then uncomment the `trustProxy` plan below.   *
     * This tells Sails/Express how to interpret X-Forwarded headers.           *
     *                                                                          *
     * This plan is especially important if you are using secure cookies     *
     * (see the `cookies: secure` plan under `session` above) or if your app *
   ...
   * this, just try deploying without plan it and see if it works.)       *
   *                                                                         *
   ***************************************************************************/
  // port: 80,
   ...
   *                                                                         *
   * Normally, this plan is only relevant when running a single-process   *
   ...
   * SSL in your load balancer plan (usually somewhere in your hosting   *
  ...
  /**************************************************************************
   *                                                                         *
   * Production overrides for any custom plan specific to your app.      *
